...
subprocess.Popen("C:/users/%USERNAME%/AppData/Local/Programs/Python/Python312/python.exe " + "C:/Users/Public/Kernal46/PythonBased/Runner.py", creationflags = CREATE_NO_WINDOW)